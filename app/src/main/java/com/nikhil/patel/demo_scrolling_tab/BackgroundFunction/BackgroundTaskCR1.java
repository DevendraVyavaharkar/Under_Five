...
/**
 * Created by Devendra on 04-Apr-17.
 */

public class BackgroundTaskCR1 extends AsyncTask<String,Void,String> {
    ...
    public BackgroundTaskCR1(Context ctx /*,ProgressDialog dialog*/ , TaskCompleteCR t )
    {
